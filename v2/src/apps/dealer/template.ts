                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(min(100%,300px),1fr));gap:16px">
                  \${ (propsReady || []).map(p => \`
                    <div style="\${p.cardWrap}" style-hover="transform:translateY(-3px)">
                      ...
                      <div style="padding:14px 16px 16px;\${p.cardBodyStyle}flex:1;display:flex;flex-direction:column;justify-content:space-between;min-height:0">
          ...
          \${ addClientBigOpen ? \`
            <div
              ...
              <div
                ...
                <div style="display:flex;align-items:center;gap:16px;padding:22px 30px;background:linear-gradient(135deg, #8B5CF6 0%, #D946EF 100%);">
                  <span
                    style="width:56px;height:56px;border-radius:18px;background:#ffffff;color:#8B5CF6;display:grid;place-items:center;flex:none"><i
                  ...
                  <button onClick="\${__b(closeAddClientBig)}"
                    style="width:48px;height:48px;border-radius:15px;background:#ffffff;color:#8B5CF6;display:grid;place-items:center;flex:none"
          ...
          \${ addSellerOpen ? \`
            <div
              ...
              <div
                ...
                <div style="display:flex;align-items:center;gap:16px;padding:22px 30px;background:linear-gradient(135deg, #FF6B6B 0%, #FF8E53 100%);">
                  <span
                    style="width:56px;height:56px;border-radius:18px;background:#ffffff;color:#FF6B6B;display:grid;place-items:center;flex:none"><i
                      class="ph-fill ph-key" style="font-size:28px"></i></span>
                  <div style="flex:1;min-width:0">
                    <div
                      style="font-family:'Newsreader',serif;font-weight:500;font-size:32px;letter-spacing:-.02em;color:#ffffff">
                      Add a seller</div>
                    <div style="font-size:17px;font-weight:700;color:rgba(255, 255, 255, 0.9)">Save them once — reuse them on every
                      property they give you.</div>
                  </div>
                  <button onClick="\${__b(closeAddSeller)}"
                    style="width:48px;height:48px;border-radius:15px;background:#ffffff;color:#FF6B6B;display:grid;place-items:center;flex:none"
                    style-hover="background:#fff"><i class="ph-bold ph-x" style="font-size:20px"></i></button>
                </div>
