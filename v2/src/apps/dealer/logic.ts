      ...
      ...(() => {
        ...
        return {
          ...
          cfArea: 'width:100%;margin-top:11px;padding:16px 18px;border-radius:15px;border:none;background:#fff8e6;box-shadow:inset 0 0 0 2px #f0d493;font-size:17px;font-weight:600;color:#241f1c;outline:none;resize:vertical',
            sfInput: 'width:100%;height:56px;padding:0 18px;border-radius:13px;border:1px solid #dcd0f3;background:#faf7ff;font-size:16px;font-weight:600;color:#241f1c;outline:none',
            sfArea: 'width:100%;margin-top:11px;padding:16px 18px;border-radius:13px;border:1px solid #dcd0f3;background:#faf7ff;font-size:16px;font-weight:600;color:#241f1c;outline:none;resize:vertical',
