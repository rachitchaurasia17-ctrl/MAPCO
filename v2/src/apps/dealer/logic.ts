...
export class Component extends DCLogic {
  ...
  dealListVM(d) {
    ...
    return {
      ...
      cardStyle: `display:flex;align-items:center;gap:15px;padding:15px 16px;min-width:0;background:${m.card};border:3px solid rgba(0,0,0,0.4);border-radius:18px;cursor:pointer;box-shadow:0 1px 2px rgba(30,28,22,.03),0 14px 34px -26px rgba(30,28,22,.6);transition:transform .12s`,
  ...
  renderVals() {
    ...
    const activeDeals = activeRows.map((d, i) => {
      ...
      return {
        ...
        cardStyle: 'border-radius:24px;padding:20px 22px 22px;background:' + cardColor.bg + ';background-image:linear-gradient(155deg,rgba(255,255,255,.74),rgba(255,255,255,0) 64%);border:3px solid rgba(0,0,0,0.4);box-shadow:0 20px 40px -28px rgba(40,30,10,.8)',
    ...
    const lostDeals = dLostAll.filter(dMatch).map(d => {
      ...
      return {
        ...
        cardStyle: 'border-radius:24px;padding:20px 22px 22px;background:#fff0f4;border:3px solid rgba(0,0,0,0.4);box-shadow:0 20px 40px -28px rgba(127,29,29,.2)',
      ...
      ...(() => {
        ...
        const cliCards = liveC
          ...
          .map((c, idx) => {
            ...
            return {
              ...
              cardStyle: `min-width:0;text-align:left;background:${theme.bg};background-image:${theme.bgGrad};border-radius:24px;padding:22px 24px;border:3px solid rgba(0,0,0,0.4);box-shadow:0 18px 40px -26px ${theme.shadow};transition:transform .13s,box-shadow .13s;cursor:pointer`,
        ...
        const linkVM = (l) => {
          ...
          return {
            ...
            cardStyle: `background:${st.card};border-radius:24px;padding:22px 24px 22px 22px;border:3px solid rgba(0,0,0,0.4);box-shadow:0 18px 40px -32px rgba(40,30,10,.8)`,
        ...
        return {
          ...
          cfInput: 'width:100%;height:56px;padding:0 18px;border-radius:15px;border:none;background:#ffffff;box-shadow:inset 0 0 0 2px #f0d493;font-size:17px;font-weight:600;color:#241f1c;outline:none',
          cfArea: 'width:100%;margin-top:11px;padding:16px 18px;border-radius:15px;border:none;background:#ffffff;box-shadow:inset 0 0 0 2px #f0d493;font-size:17px;font-weight:600;color:#241f1c;outline:none;resize:vertical',
            sfInput: 'width:100%;height:56px;padding:0 18px;border-radius:13px;border:1px solid #dcd0f3;background:#ffffff;font-size:16px;font-weight:600;color:#241f1c;outline:none',
            sfArea: 'width:100%;margin-top:11px;padding:16px 18px;border-radius:13px;border:1px solid #dcd0f3;background:#ffffff;font-size:16px;font-weight:600;color:#241f1c;outline:none;resize:vertical',
...
cfDup: !!cfDupC, cfDupName: cfDupC ? cfDupC.name : '', cfDupSub: cfDupC ? (cfDupC.phone + ' · ' + (cfDupC.city || '')) : '',
          ...
          sfKindChips: this.SELLERKINDS.map(k => ({ label: k, go: () => this.setSF2({ kind: k }), style: chip(sf2.kind === k, '#a3541b', '#fff0d6') })),
          sfSave: () => this.saveNewSeller(),
          sfSaveStyle: `display:flex;align-items:center;gap:10px;height:60px;padding:0 30px;border-radius:17px;font-size:18px;font-weight:800;${sfOK ? 'background:#12a150;color:#fff;box-shadow:0 14px 28px -14px rgba(18,161,80,.9)' : 'background:#e7e0d2;color:#a89e8b;cursor:not-allowed'}`,
          ...
          fuCards: followList.map(x => {
            ...
            return {
              ...
              hasMore: rs.length > 1,
              card: 'width:100%;text-align:left;border-radius:20px;background:linear-gradient(135deg, #fff0f3, #ffe3e8);padding:17px 18px 18px;border:3px solid rgba(0,0,0,0.4);box-shadow:0 16px 34px -22px rgba(90,10,20,.6);transition:transform .15s;cursor:pointer',
