-- MAPCO V2 · Client links: photos are now OPTIONAL (recreated from 001500,
-- "at least one approved photo" requirement removed; all other checks unchanged).
...
begin
  ...
  loop
    ...
    -- (photo-optional) links may be created even if a property has no photos.
