-- Emergency rollback for the initial Founder device-access rollout.
-- Keep device/session/audit evidence, but restore the pre-rollout request,
-- tenant, buyer-link and grant boundaries.
